      ...
      <div className="program-hero">
        <section>
          <div className="program-image">
            <amp-img src="/static/coding-dino@2x.png" width="554px" height="366px" layout="responsive"></amp-img>
          </div>
          <h1>코드랩</h1>
        ...
        <section>
          <div className="program-image">
            <amp-img src="/static/meditation-dino@2x.png" width="554px" height="304px" layout="responsive"></amp-img>
          </div>
          <h1>명상 세션</h1>
